...
|---|---|---|---|
| `docs/design.md` | The master design & technical document; the contract. Sections 1–20: vision, galaxy, economy/manufacturing tiers, ventures & the Exchange, logistics, politics, fuel, storyteller, bots, narrative layer, onboarding, architecture, data model & invariants, seed generation, roadmap summary, AI workflow, open questions | ✅ Current through 04-08-26 (last consolidated 19-07-26) | Ongoing upkeep in the same commit as the code it describes (incl. bumping the header date) |
| `docs/roadmap.md` | Authoritative phase-by-phase checklists and exit criteria | ✅ Current (04-08-26); Track G generator complete 02-08-26 | Boxes ticked as work lands; Phase 1 walking skeleton continuing |
