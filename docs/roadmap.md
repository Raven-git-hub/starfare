...
- [ ] First: search the local machine for the 15-07 `generate_seed.js`, `system_planet_ui_mockup.html`, `galaxy-map-hex.html`, `SyndicateMarketplace.jsx`; commit anything found and strike it from this list
