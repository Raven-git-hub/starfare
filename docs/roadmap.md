...
| 1 | Playable economy sandbox (widened) | 🔶 In progress — Stage 1 ✅, checklist ✅ (19-07-26); Stage 2: harness + driver + zero-state ✅ (01-08-26), resource representation ✅ (02-08-26), state inspector ✅ (03-08-26), live world→seed + home-seating ✅ (03-08-26), establish-venture action + claims-in-snapshot ✅ (03-08-26), testbed server + container ✅ (03-08-26), testbed web UI ✅ (03-08-26), refining (titanium→alloy) ✅ (03-08-26), home-system picker (/starters) ✅ (04-08-26), system-layout endpoint (/system/:id) ✅ (04-08-26), guild-management overlay (read-only) ✅ (04-08-26), planet manifest + establish-in-UI (/recipes) ✅ (04-08-26), multi-input recipe engine ✅ (04-08-26), walking skeleton continuing |
